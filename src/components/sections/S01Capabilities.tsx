        ...
        <div className="section-pad">
          ...
          <div className="container-doc mt-16 md:mt-24">
            <div className="md:grid-12" data-cap-scene>
              {/* Continuous drawing, desktop. Static renders show the final
                  composition; with motion GSAP draws it stage by stage. */}
            ...
            <ul
              className="hairline-t mt-24 md:mt-32"
              aria-label="Supporting services"
            >
              {support.map((row) => (
                <li
                  key={row.title}
