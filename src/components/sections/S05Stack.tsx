        ...
        <div className="container-doc mt-16 md:mt-24">
          ...
          <div className="hidden md:block">
            ...
            <div className="relative mt-14" data-stack-wrap>
              ...
              <div
                className="mono pointer-events-none absolute left-0 top-0 hidden max-w-[36ch] border border-rule bg-paper-raised px-3 py-2 normal-case leading-relaxed tracking-normal text-ink"
